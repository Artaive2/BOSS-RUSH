...
//Second phase
if(phase == smoke_phases.second){
	
	sprite_index = s_smoke_boss_second;
	
	//Draw hands
	draw_sprite(s_hands_second, hands_image_num, hands_x + 16, hands_y + 5);
	draw_sprite_ext(s_hands_second, hands_image_num, hands_x - 16, hands_y + 5, -1, 1, 0, c_white, 1);
